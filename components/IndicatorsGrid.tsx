...
export default function IndicatorsGrid({ accum, themes }: Props) {
  ...
  const cells = [
    ...
    {
      label: "Inflow today",
      value: fmtCompact(accum.inflowsUsdM),
      sub: "USD millions",
      tone: accum.inflowsUsdM >= 0 ? "positive" : "negative",
    },
    {
      label: "Outflow today",
      value: fmtCompact(accum.outflowsUsdM),
      sub: "USD millions",
      tone: accum.outflowsUsdM <= 0 ? "negative" : "positive",
    },
    {
      label: "Phase",
